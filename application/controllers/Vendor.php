...
class Vendor extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'start' => $start,
            'content' => 'backend/vendor/vendor_list',
        );
    ...
    public function lookup()
    {
        ...
        $data = array(
            ...
            'total_rows' => $config['total_rows'],
            'start' => $start,
            'content' => 'backend/vendor/vendor_lookup',
        );
        ob_start();
    ...
    public function read($id) 
    {
		...
		'telp' => $row->telp,
		'alamat' => $row->alamat,'content' => 'backend/vendor/vendor_read',
	    );
            $this->load->view(
            layout(), $data);
        } else {
    ...
    public function create() 
    {
	    ...
	    'content' => 'backend/vendor/vendor_form',
	);
        $this->load->view(layout(), $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2019-06-02 02:51:21 */
/* http://harviacode.com */